...
public class brandResults extends javax.swing.JFrame {
    ...
    // Creates new form brandResults
    public brandResults(String brandname_chosen_value, Date s, Date e,int cus_id) {
        initComponents();

        model = (DefaultTableModel) this.brand_table.getModel();
        show_cars_with_this_brandname_on_table(brandname_chosen_value);

        brand_table.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);

         brand_table.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
    ...
    public void show_cars_with_this_brandname_on_table(String brandname_chosen_value) {
        ...
        try {
            ...
            String q1 = "select veichletypeid from veichletype where brandname='" + brandname_chosen_value + "'";
            Statement s = con.createStatement();
            ResultSet r1 = s.executeQuery(q1);
            r1.next();

            String q = "select veichleid,model,color from veichle where veichletypeid='" + r1.getInt("veichletypeid") + "'";
            ...
            while (r.next() == true) {
                ...
                model.addRow(new Object[]{brandname_chosen_value, car_id, car_model, color});
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Brand Filteration Results ");
        ...
        if (brand_table.getColumnModel().getColumnCount() > 0) {
            brand_table.getColumnModel().getColumn(0).setResizable(false);
            brand_table.getColumnModel().getColumn(1).setResizable(false);
            brand_table.getColumnModel().getColumn(2).setResizable(false);
            brand_table.getColumnModel().getColumn(3).setResizable(false);
        }
    ...
    private void select_car_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_select_car_btnActionPerformed
        ...
        int selected_row = this.brand_table.getSelectedRow();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(brandResults.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //dummy passed value
                new brandResults("", null, null,0).setVisible(true);
            }
        });
    }
